...
Booking itself does real CRM work inside one n8n workflow: check for slot conflicts, create the Calendar event, look up or create the EspoCRM Contact, then create an Opportunity linked to both. The same architecture now runs a second agent variant for a real-estate client (Horizon Realty), unified under a shared "Multi-Industry Demo Switchboard" Retell agent, with its own automated lead scoring and 19-test regression suite validating the Calendar/CRM integration end to end.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/minions-landing.png", alt: "Minions.AI 24/7 AI Voice Dispatcher & Speed-to-Lead Platform" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/minions-crew.png", alt: "Minions Digital Crew Members & Voice Pipeline Architecture" },
      ],
      order: 0,
    },
    {
...
A new tenant onboards through a 4-step self-serve wizard: a company snapshot (URL + name, auto-inferred), a one-click LinkedIn OAuth connect that pulls real recent post text into a voice sample, a 3-question brand interview that runs one LLM call to draft brand directives, and a review-and-launch step that provisions the tenant's channels and fires the first content harvest in the background. Underneath it, the tenancy model is real: a 16-model Prisma schema (Client, ClientChannel, ToneExample, Subscription, UsageEvent, and others) with full per-tenant data isolation, tested end-to-end with a real second tenant.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/minions-cockpit.png", alt: "Minions.AI Multi-Agent Mission Control Cockpit & Telemetry" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/minions-blog.png", alt: "Autonomous Technical Content & Field Guide Engine" },
      ],
      order: 1,
    },
    {
...
Access control isn't hardcoded into the app's role checks — permissions are rows in the database, so the org's structure can change without a code change. Payroll rules were built to match how GenMorphics actually pays people: hourly for operational work, salaried with hourly fallback for managerial roles.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/genmorphics-app.png", alt: "GenMorphics AI Secure Google & Microsoft Enterprise SSO Sign In" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/genmorphics-overview.png", alt: "GenMorphics AI Expert Dashboard & Task Management" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/genmorphics-skills.png", alt: "Granular Skill Matrix & Software Specialization Manager" },
      ],
      order: 2,
    },
    {
...
Underneath the live conversation, a scheduled analyzer classifies each idle conversation for the merchant dashboard — but only the ambiguous outcomes go through an LLM; whether an order actually converted is read straight from the database, not inferred. That feeds a real insights dashboard (funnel, lost-reasons, demand gaps, stockout cost) and a staged follow-up system that nudges quiet-but-interested customers back, respecting each platform's own messaging-window rules.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/sellervai-home.png", alt: "SellerVai AI Social Commerce Salesperson & Multichannel Platform" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/sellervai-solutions.png", alt: "Omnichannel Support across WhatsApp, Messenger, Instagram & Telegram" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/sellervai-pricing.png", alt: "SellerVai Merchant Subscription & Automation Packages" },
      ],
      order: 3,
    },
    {
...
For payments, instead of trusting the webhook payload, every IPN triggers an active server-to-server query back to SSLCommerz's own validation API, cross-checked against the amount recorded at checkout and SSLCommerz's own risk score, with every attempt logged to an audit table for reconciliation.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/mathpro-home.png", alt: "MathPro Academy Mathematics Coaching & Founder Overview" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/mathpro-courses.png", alt: "JSC, SSC & HSC Specialized Mathematics Course Tracks" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/mathpro-features.png", alt: "Interactive Math Learning Features & Automated Checkout" },
      ],
      order: 4,
    },
    {
...
For video, we deliberately didn't build a custom encoding pipeline. Editorial walkthroughs are delivered through BunnyCDN Stream (HLS) or plain YouTube embeds — proven infrastructure for the actual problem, rather than an in-house transcoding stack that would mostly duplicate what a CDN already does well.`,
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/codervai-courses.png", alt: "Codervai All Courses & Bundle Catalog" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/codervai-module-dashboard.png", alt: "Codervai Student Learning Cockpit, Streaks & Module Progression" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/codervai-mylearning.png", alt: "Enrolled Competitive Programming Courses & Course Bundles" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/codervai-home.png", alt: "Codervai Competitive Programming Academy Homepage" },
      ],
      order: 5,
    },
    {
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/cprbd-home.png", alt: "Center for Policy Research on Business and Development Portal" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/cprbd-programs.png", alt: "National Executive Training Cohorts & Certificate Verification" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/cprbd-researches.png", alt: "National Policy Research & Academic Publications Repository" },
      ],
      order: 6,
    },
    {
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/ln-assistant-home.png", alt: "LinkedIn Brand Assistant AI Companion Landing Page" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/ln-assistant-store.png", alt: "Chrome Web Store Published Extension" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/ln-assistant-features.png", alt: "AI Comment Tone Customization & Workflow Engine" },
      ],
      order: 7,
    },
    {
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/badhan-home.png", alt: "Badhan Amar Ekushey Hall Unit Dashboard & Live Blood Group Breakdown" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/badhan-search.png", alt: "Real-time Donor Search & Multi-criteria Eligibility Filter" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/badhan-records.png", alt: "Donor Records & Unit Donation Logs" },
      ],
      order: 8,
    },
    {
      ...
      gallery: [
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/luxeory-hero.jpg", alt: "Luxeory Full-Stack Hotel Booking Platform Hero" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/luxeory-preview.jpg", alt: "Luxeory Reservation & Property Management Overview" },
        { url: "https://pub-13629069dfd74891bffc487ab4e135f5.r2.dev/projects/luxeory-booking.jpg", alt: "Luxeory Guarded Checkout & Room Selection" },
      ],
      order: 9,
    },
  ];
...
const sectionContent: Record<SectionKey, unknown> = {
  ...
  meeting: {
    ...
    description:
      "Book a live 15-minute slot directly on my calendar via Cal.com, or propose a time that works best for you.",
  ...
  seo: {
    ...
    description:
      "Software Engineer & AI Systems Developer. I build production AI voice pipelines, reliable payment webhook infrastructure, and full-stack systems.",
    ogImage: "/og.jpg",
