...
const covers = [
  ...
  },
  {
    ...
    title: "Self-Healing Chrome Extensions",
    subtitle: "AI-Regenerated Selectors vs. LinkedIn's Obfuscated DOM",
    accent: "#EC4899",
    metric: "5-Layer Fallback",
    metricLabel: "AI strategy to hardcoded to heuristic parser",
  },
  {
    filename: "offline-first-pwa-networks.png",
    kicker: "AI PARSING & DONOR NETWORKS",
    title: "Teaching an LLM to Parse Telegram",
    subtitle: "Gemini-First AI Parsing with a Deterministic Regex Fallback",
    accent: "#EF4444",
    metric: "407 / 599",
    metricLabel: "Donors tracked / donations logged",
  },
  {
