...
export default function Meeting({ section = defaultSection }) {
  const form = useRef();
  ...
  return (
    <section id="meeting" className="border-b border-line py-20 lg:py-28">
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-4 rounded-2xl border border-line bg-ink-2 p-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-medium text-white">{content.durationLabel}</p>
                </div>
              </div>
